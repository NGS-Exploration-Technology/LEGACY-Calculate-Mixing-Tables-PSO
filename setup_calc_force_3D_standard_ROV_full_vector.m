function [Thruster_Params] = setup_calc_force_3D_standard_ROV_full_vector()
...
%Define Thruster Configuration (index for Thruster_Params is Thruster ID)
    ...
    Thruster_Params(1).thrust = -0.38634; %[N] Force imparted by thruster
    %Thruster 2
    ...
    Thruster_Params(2).thrust = 0.38634; %[N] Force imparted by thruster
    %Thruster 3
    ...
    Thruster_Params(3).thrust = 0.38634; %[N] Force imparted by thruster
    %Thruster 4
    ...
    Thruster_Params(4).thrust = -0.38634; %[N] Force imparted by thruster
    %Thruster 5
    Thruster_Params(5).position(1) = 0; %[m] x Location of Thruster on frame
    ...
    Thruster_Params(5).yaw_angle = 90; %[deg] Angle of Thruster from X
    Thruster_Params(5).pitch_angle = -60; %[deg] Angle of Thruster from XY plane
    Thruster_Params(5).thrust = -0.19097; %[N] Force imparted by thruster
    %Thruster 6
    Thruster_Params(6).position(1) = 0; %[m] x Location of Thruster on frame
    Thruster_Params(6).position(2) = -0.5; %[m] y Location of Thruster on frame
    Thruster_Params(6).position(3) = 0; %[m] z Location of Thruster on frame
    Thruster_Params(6).yaw_angle = -90; %[deg] yaw angle of Thruster from X
    Thruster_Params(6).pitch_angle = -60; %[deg] pitch ngle of Thruster from XY plane
    Thruster_Params(6).thrust = 0.19097; %[N] Force imparted by thruster

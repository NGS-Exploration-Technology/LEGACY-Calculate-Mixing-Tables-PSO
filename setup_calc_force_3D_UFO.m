function [Thruster_Params] = setup_calc_force_3D_UFO()
...
%Define Thruster Configuration (index for Thruster_Params is Thruster ID)
    %Thruster 1
    Thruster_Params(1).position(1)= 0.1443; %[m] x Location of Thruster on frame WRT center of mass
    ...
    Thruster_Params(1).pitch_angle = 0; %[deg] Angle of Thruster from XY plane
    Thruster_Params(1).thrust = 0; %[N] Force imparted by thruster
    %Thruster 2
    Thruster_Params(2).position(1) = 0.1443; %[m] x Location of Thruster on frame
    ...
    Thruster_Params(2).pitch_angle = 0; %[deg] Angle of Thruster from XY plane
    Thruster_Params(2).thrust = 0; %[N] Force imparted by thruster
    %Thruster 3
    Thruster_Params(3).position(1) = -0.2887; %[m] x Location of Thruster on frame
    Thruster_Params(3).position(2) = 0; %[m] y Location of Thruster on frame
    Thruster_Params(3).position(3) = 0; %[m] z Location of Thruster on frame
    Thruster_Params(3).yaw_angle = 90; %[deg] Angle of Thruster from X
    Thruster_Params(3).pitch_angle = 0; %[deg] Angle of Thruster from XY plane
    Thruster_Params(3).thrust = 0; %[N] Force imparted by thruster
    %Thruster 4
    Thruster_Params(4).position(1) = 0.1443; %[m] x Location of Thruster on frame
    ...
    Thruster_Params(4).yaw_angle = 0; %[deg] Angle of Thruster from X
    Thruster_Params(4).pitch_angle = -90; %[deg] Angle of Thruster from XY plane
    Thruster_Params(4).thrust = 0; %[N] Force imparted by thruster
    %Thruster 5
    Thruster_Params(5).position(1) = 0.1443; %[m] x Location of Thruster on frame
    Thruster_Params(5).position(2) = 0.5; %[m] y Location of Thruster on frame
    ...
    %Thruster 6
    Thruster_Params(6).position(1) = -0.2887; %[m] x Location of Thruster on frame

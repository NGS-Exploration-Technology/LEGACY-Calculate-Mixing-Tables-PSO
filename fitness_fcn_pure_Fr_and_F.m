function loss = fitness_fcn_pure_Fr_and_F(x,Thruster_Params,Fr_target,F_target);
%FITNESS_FCN_MR_AND_F specific to forces
...
%Resultant Translations Error
mse_Fr = (norm(Fr(4:6)-Fr_target(4:6)))^2;

%Resultant Moments Error
mse_Mr = (norm(Fr(4:6)-Fr_target(4:6)))^2;
